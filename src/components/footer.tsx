                            ...
                            <div className="grid grid-cols-2 gap-8 sm:gap-6 lg:grid-cols-5 text-xs md:text-sm md:grid-cols-3 ">
                                ...
                                <div>
                                    ...
                                    <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                                        ...
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/shipping-terms" className="hover:text-blue-500 text-gray-500 underline-tra">{langData.footer.bottom_part.our_policies.ship_terms}</Link>
                                        </li>
                                        <li >
